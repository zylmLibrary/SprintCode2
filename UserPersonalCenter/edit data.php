	...
	<body onLoad="loadXMLDoc(<?php echo $RdId;?>,<?php echo $number;?>)">
		...
		<div class="main w1200">
			<div class="left">
				<ul id="menu">
					<li>
						<a href="UserPersonalCenter.php?number=1" class="active" id="1">
							<i class="icon iconfont icon-lingdang"></i>
							个人资料
						</a>
					</li>
					<li>
						<a href="UserPersonalCenter.php?number=2" id="2">
							<i class="icon iconfont icon-fangzidichan"></i>
							借阅记录
						</a>
					</li>
					<li>
						<a href="Book renewal.php?" id="3">
							<i class="icon iconfont icon-pinglun"></i>
							图书续约
						</a>
					</li>
					<li>
						<a href="UserPersonalCenter.php?number=4" id="4">
...
//编辑资料
	...
	?><script>location.href='PersonalWin.php';</script><?php
					...
					?>
                    <form action="../PersonalWin/PersonalWin.php" method="post">
	<br>
