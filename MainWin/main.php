...
function number(id ,bkid)
  {
  var name=prompt("请输入书籍的唯一书号");
  var url='borrow.php?RdId='+id+'&&BkId='+name+"&&bkid="+bkid;
  if (name!=null && name!="")
    {
    self.location=url;
    }
...
<body>
	...
	?>
				<tr>
					...
					<td><div align="center"><span>
						...
						<a onclick="number(<?php echo $id;?>,<?php echo $bkid?>)">借阅</a>
					</span></div></td>
				</tr>
	<?php
			}
	...
	<div class="r"><a href="../UserPersonalCenter/Personal data.php?RdId=<?php echo $id ?>">个人中心</a></div>
</body>
</html>
